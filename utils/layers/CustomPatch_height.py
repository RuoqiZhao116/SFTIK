...
class CustomPatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.patch_size = (patch_width, self.img_size[1])  # Patch size (16,224)
        ...
        self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=self.patch_size, stride=(patch_width, self.img_size[1]), bias=bias)
